...
Features (Input): Usage_kWh(kWh), Lagging_Current_Reactive.Power_kVarh(kVarh), Leading_Current_Reactive_Power_kVarh (kVarh), CO2(tCO2) (ppm), Lagging_Current_Power_Factor (%), Leading_Current_Power_Factor (%), Number of Seconds from midnight, NSM (s), Day_of_week, WeekStatus.
